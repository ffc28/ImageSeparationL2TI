...
patches_recto = []
for pic_set in np.arange(15): # I'm using all the images for the learning
    
    img_train = mpimg.imread('./images/set'+ str(pic_set + 1) + '_pic1.png')
